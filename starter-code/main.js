      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "3":
            ...
            db.collection('companies').find({ $and: [ { founded_year: 2004 }, { founded_month: 2 } ] }).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
            ...
            db.collection('companies').find({ $and: [ {founded_year: 2004}, { founded_month: {$gt: 3}}, {founded_month: {$lt: 7}}]},{founded_month: 1}).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
            ...
            db.collection('companies').find({ "offices.city": { $eq: 'Barcelona' } }).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
            ...
            db.collection('companies').find({},{number_of_employees: 1}).limit(10).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
            ...
            db.collection('companies').find({name: 'Facebook'},{number_of_employees: 1}).count((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
            ...
            db.collection('companies').find({"relationships.person.permalink": "david-ebersman"}).count((error, result) => {
              if (error) {
                console.log(result);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
            ...
            db.collection('companies').find({$and:[{"tag_list": {$regex: 'social-network'}},{ "founded_year": { $gte: 2002 } }, { founded_year: { $lte: 2016 } }] }).count((error, result) => {
              if (error) {
                console.log(result);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
            ...
            db.collection('companies').find({"offices.city": "London"}).count((error, result) => {
              if (error) {
                console.log(result);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
            ...
            db.collection('companies').find(({$and:[{"tag_list": {$regex: 'social-network'}},{ "founded_year": { $gte: 2002 } }, { founded_year: { $lte: 2016 } },{"offices.city":"New York"}] })).count((error, result) => {
              if (error) {
                console.log(result);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
